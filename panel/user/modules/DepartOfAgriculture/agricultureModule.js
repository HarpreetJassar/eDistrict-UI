...
.controller('issueseedCtrl', function($location,
    ...
    User) {
        ...
        $scope.$watch('app.Districtid', function() {
            AgricultureFactory.fetch({
                selectfrom: "sub_district_lgd",
                selectby: "",
                selectionparam: $scope.app.Districtid,
                selectionparam1: ""
            }).then(function (res) {
                $.each(res.data, function(key, value) {
                    t = (JSON.parse(value));
        ...
        $scope.$watch('app.Tehsilid', function () {
            AgricultureFactory.fetch({
                selectfrom: "village_lgd",
                selectby: "subDistrictCode",
                selectionparam: $scope.app.Tehsilid,
                selectionparam1: ""
            }).then(function (res) {
                $.each(res.data, function(key, value) {
                    t = (JSON.parse(value));
